...
#apenas matriz homogenea constituida por uma translaçao: para coincidir as posiçoes
#com o mapa no lazarus, o eixo y é positivo para baixo (como no ref da camara)
...
cap.set(cv2.CAP_PROP_FRAME_WIDTH, 640 ) #640 #634 #1280
cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 480) #480 #468 #720
